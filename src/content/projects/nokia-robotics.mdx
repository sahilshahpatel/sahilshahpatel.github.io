...
import nokiaRoboticsTeamImg from "/src/assets/images/projects/nokiaRoboticsTeam.jpg"
...
<Image class="mt-400 w-100" widths={[300, 500, 750, 1000, nokiaRoboticsTeamImg.width]} style="height: auto;" src={nokiaRoboticsTeamImg} alt="My robotics team receiving a participation certificate from Nokia" loading="lazy" />

...
img: "foodle.jpg"
links: {
    github: "https://github.com/sahilshahpatel/HackRidge2018"
}
description: "A website built for my first hackathon. Mimics collaborative filtering algorithms to find recommended recipes based on your history and friends."
---
import Image from "@components/image-wrapper.astro"
import hackridgeImg from "@images/projects/hackridge.jpg"
...
<Image class="mt-400 w-100" src={hackridgeImg} alt="My team and me with our first place medals at HackRidge 2018" loading="lazy"/>

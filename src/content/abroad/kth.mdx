---
order: 1
what: "KTH Royal Institute of Technology"
where: "Stockholm, Sweden"
when: "January 2022 - June 2022"
img: "stockholm-sunset.jpg"
imgPos: "center"
---
import Image from "../../components/image-wrapper.astro"

import boardGameNightImg from "/src/assets/images/abroad/kth-board-game-night.jpg"
import kirunaPlaneWindowImg from "/src/assets/images/abroad/kth-kiruna-plane-window.jpg"
import kirunaAuroraImg from "/src/assets/images/abroad/kth-kiruna-aurora.jpg"
import kirunaGroupImg from "/src/assets/images/abroad/kth-kiruna-group.jpg"

import munichGroupImg from "/src/assets/images/abroad/kth-munich-group.jpg"
import copenhagenGroupImg from "/src/assets/images/abroad/kth-copenhagen-group.jpg"
import norwayGroupImg from "/src/assets/images/abroad/kth-norway-cabins-group-tall.jpg"

import vicMigrationDemoImg from "/src/assets/images/abroad/kth-vic-migration-demo.jpg"
import vicImg from "/src/assets/images/abroad/kth-vic-iss.jpg"
import orbiteyeImg from "/src/assets/images/abroad/kth-orbiteye-presentation.jpg"

import lucaImg from "/src/assets/images/abroad/kth-luca-and-me.jpg"
import pascalImg from "/src/assets/images/abroad/kth-pascal-birthday.jpg"
import lukasImg from "/src/assets/images/abroad/kth-lukas-teknikringen-welcome.jpg"
...
<Image class="single-img box-shadow-float-high" src={boardGameNightImg} alt="KTH board game night" loading="lazy" />
...
<div class="img-grid">
    <div class="column">
        <Image class="box-shadow-float-high" src={kirunaPlaneWindowImg} alt="Out a plane window" loading="lazy" />
    </div>
    <div class="column">
        <div class="row">
            <Image class="box-shadow-float-high" src={kirunaAuroraImg} alt="The aurora" loading="lazy" />
        </div>
        <div class="row">
            <Image class="box-shadow-float-high" src={kirunaGroupImg} alt="Our group in front of the cabins" loading="lazy" />
        </div>
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <div class="row">
            <Image class="box-shadow-float-high" src={munichGroupImg} alt="My friends and me in Munich" loading="lazy" />
        </div>
        <div class="row">
            <Image class="box-shadow-float-high" src={copenhagenGroupImg} alt="Group photo on top of a clock tower in Copenhagen" loading="lazy" />
        </div>
    </div>
    <div class="column">
        <Image class="box-shadow-float-high" src={norwayGroupImg} alt="Group photo outside cabins on Luster Fjord in Norway" loading="lazy" />
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <div class="row">
            <Image class="box-shadow-float-high" src={vicMigrationDemoImg} alt="Me user testing another project for Information Visualization" loading="lazy" />
        </div>
        <div class="row">
            <Image class="box-shadow-float-high" src={vicImg} alt="The visualization studio (VIC) at KTH" loading="lazy" />
        </div>
    </div>
    <div class="column">
        <Image class="box-shadow-float-high" src={orbiteyeImg} alt="Our final presentation for OrbitEye" loading="lazy" />
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <Image class="box-shadow-float-high" src={lucaImg} alt="My roommate and me outside KTH main campus" loading="lazy" />
    </div>
    <div class="column">
        <div class="row">
            <Image class="box-shadow-float-high" src={pascalImg} alt="Us celebrating Pascal's birthday" loading="lazy" />
        </div>
        <div class="row">
            <Image class="box-shadow-float-high" src={lukasImg} alt="A housewarming pizza party for Lukas" loading="lazy" />
        </div>
    </div>
</div>
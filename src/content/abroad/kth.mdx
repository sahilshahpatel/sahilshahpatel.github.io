...
img: "/images/abroad/stockholm-sunset.jpg"
imgPos: "center"
---
...
<img class="single-img box-shadow-float-high" src="/images/abroad/kth-board-game-night.jpg" alt="KTH board game night" loading="lazy" />
...
<div class="img-grid">
    <div class="column">
        <img class="box-shadow-float-high" src="/images/abroad/kth-kiruna-plane-window.jpg" alt="Out a plane window" loading="lazy" />
    </div>
    <div class="column">
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-kiruna-aurora.jpg" alt="The aurora" loading="lazy" />
        </div>
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-kiruna-group.jpg" alt="Our group in front of the cabins" loading="lazy" />
        </div>
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-munich-group.jpg" alt="My friends and me in Munich" loading="lazy" />
        </div>
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-copenhagen-group.jpg" alt="Group photo on top of a clock tower in Copenhagen" loading="lazy" />
        </div>
    </div>
    <div class="column">
        <img class="box-shadow-float-high" src="/images/abroad/kth-norway-cabins-group-tall.jpg" alt="Group photo outside cabins on Luster Fjord in Norway" loading="lazy" />
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-vic-migration-demo.jpg" alt="Me user testing another project for Information Visualization" loading="lazy" />
        </div>
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-vic-iss.jpg" alt="The visualization studio (VIC) at KTH" loading="lazy" />
        </div>
    </div>
    <div class="column">
        <img class="box-shadow-float-high" src="/images/abroad/kth-orbiteye-presentation.jpg" alt="Our final presentation for OrbitEye" loading="lazy" />
    </div>
</div>
...
<div class="img-grid">
    <div class="column">
        <img class="box-shadow-float-high" src="/images/abroad/kth-luca-and-me.jpg" alt="My roommate and me outside KTH main campus" loading="lazy" />
    </div>
    <div class="column">
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-pascal-birthday.jpg" alt="Us celebrating Pascal's birthday" loading="lazy" />
        </div>
        <div class="row">
            <img class="box-shadow-float-high" src="/images/abroad/kth-lukas-teknikringen-welcome.jpg" alt="A housewarming pizza party for Lukas" loading="lazy" />
        </div>
    </div>
</div>